...
public class Store extends LocationNormally{
    ...
    private void printArmor() {
        ...
        for (Armour armor : Armour.armours()){
    ...
    public void buyArmor(){
        ...
        do {
            try {
                ...
                if (armorChoice >= 1 && armorChoice <= Armour.armours().length ){
                    break;
                }
                if (armorChoice == 0){
                    return;
        ...
        Armour selectedArmor = Armour.getArmourById(armorChoice);
