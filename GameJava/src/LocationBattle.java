...
public abstract class LocationBattle extends Location{
    ...
    public LocationBattle(Player player, String name, Monster monster, String award, int maxNumberOfMonster) {
        super(player, name);
    ...
    public void specifyRandomAward(){
        ...
        if (randomNumber > 45 ) {
            ...
            if (awardType.toLowerCase().equals("silah")){
                ...
                Weapons weapon = Weapons.weapons()[awardId-1];
                ...
                awardId = findAward(50,30,20);
                Armour armor = Armour.armours()[awardId-1];
